...
SCENARIO_REGISTRY = {
    "halt": {
        "module": "sequences.halt_sequence",
        "builder": "build_halt_sequence",
    },
    "read_dmstatus": {
        "module": "sequences.read_dmstatus_sequence",
        "builder": "build_read_dmstatus_sequence",
    },
    # Add more scenarios here:
    # "mem_scan": {
    #     "module": "sequences.mem_scan_sequence",
...
def main():
    ...
    if cfg["transport"] == "openocd":
        ...
        ocd_config = ocd_cfg.get("config",
            os.path.join(os.path.dirname(__file__), "configs", "openocd_bitbang.cfg"))
